      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <NavLink to={isAuthenticated ? "/dashboard" : "/login"} className="flex items-center gap-2.5 group">
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <button
                  ...
                  className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2.5 px-5 rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-95 transition-all text-sm cursor-pointer"
                >
                  Start Free Mock
                </button>
              </>
